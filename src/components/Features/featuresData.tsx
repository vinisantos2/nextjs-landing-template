...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Projeto desenvolvido com tecnologias atuais para oferecer desempenho, estabilidade e facilidade de manutenção.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Interface moderna e bem estruturada para proporcionar uma ótima experiência visual em diferentes dispositivos.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Estrutura otimizada para garantir carregamento rápido e excelente desempenho em qualquer dispositivo.",
  },
  {
    id: 4,
    icon: (
      <svg width="40" height="42" viewBox="0 0 40 42" className="fill-current">
        <path
          opacity="0.5"
          d="M31.8943 25.3303C34.1233 25.3303 36.1497 26.1409 37.5682 27.762L39.1464 26.1839V32.936H33.1014L35.5418 29.7885C34.5286 28.9779 33.3128 28.37 31.8943 28.37C29.0573 28.37 26.8282 30.599 26.8282 33.436C26.8282 36.273 29.0573 38.5021 31.8943 38.5021C33.3549 38.5021 34.6511 37.844 35.6345 36.8244"
        />
      </svg>
    ),
    title: "Tecnologia Atual",
    paragraph:
      "Desenvolvido com tecnologias modernas para garantir estabilidade, escalabilidade e facilidade de atualização.",
  },
  {
    id: 5,
    icon: (
    ...
    paragraph:
      "Layout flexível que permite adaptar facilmente cores, conteúdos e estrutura conforme a necessidade.",
  },
  {
    id: 6,
    icon: (
      <svg width="40" height="45" viewBox="0 0 40 45" className="fill-current">
        <path
          opacity="0.5"
          d="M31.579 37.8948C28.6737 37.8948 26.3158 35.5369 26.3158 32.6317"
        />
      </svg>
    ),
    title: "Código Organizado",
    paragraph:
      "Código limpo e bem estruturado para facilitar manutenção, melhorias e futuras expansões do projeto.",
  },
];
