...
export const metadata: Metadata = {
  title: "Blog | VS Tech",
  description:
    "Confira nossos artigos, conteúdos e novidades sobre tecnologia, desenvolvimento e soluções digitais.",
};
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Blog"
        description="Explore nossos conteúdos e descubra dicas, novidades e informações sobre tecnologia e projetos digitais."
      />
